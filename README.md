...
- `/roast` now tries a built-in fallback chain of OpenRouter models if the primary roast model is unavailable or rate-limited, with confirmed free routes first and broader fallbacks after.
